    ...
    <header id="menu-principal">
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand" href="#"><img width=100 src="./assets/img/logo-exemplo.png" alt="logo-exemplo">
                </a>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item text-dark" href="#">Nossa História</a></li>
                                <li><a class="dropdown-item text-dark" href="#">Egressos</a></li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
                                <li><a class="dropdown-item text-dark" href="#">Regimento Geral</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item text-dark" href="#">Excel Básico</a></li>
                                <li><a class="dropdown-item text-dark" href="#">Administração</a></li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
                                <li><a class="dropdown-item text-dark" href="#">Algum outro curso</a></li>
                            </ul>
                        </li>
                        <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="index.html">Contate-nos</a>
                    </li>
                    </ul>
